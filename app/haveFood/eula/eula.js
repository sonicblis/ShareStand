	...
	app.directive ("eula", ['peopleService', function (peopleService) {
		return {
			...
			controller: [function () {
				...
				this.criteriaItems = [
					{agreed: false, terms: 'The food was produced by you or someone in your family'},
					{agreed: false, terms: 'The food was produced or grown withing 10 miles of where it\'s being provided'},
					{agreed: false, terms: 'The food was produced using sustainable methods of production'}
				];
